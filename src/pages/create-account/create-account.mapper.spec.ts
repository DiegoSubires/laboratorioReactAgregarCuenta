...
describe("pages/create-account/create-account.mapper specs", () => {
  describe("mapNewAccountFromVmToApi", () => {
    it("should return empty array when it feeds empty array", () => {
      // Arrange
      const newAccount: viewModel.NewAccount = [
        {
          id: "1",
      ...
      // Act
      const result = mapNewAccountFromVmToApi(accountList);
